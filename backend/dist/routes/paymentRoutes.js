 ...
 */
router.post("/initiate", auth_1.auth, (0, requireRole_1.requireRole)(["buyer"]), (0, validate_1.validate)(paymentSchemas_1.initiatePaymentSchema), paymentController_1.initiatePayment);
/**
 * @openapi
 ...
 */
router.post("/webhook/stripe", paymentController_1.stripeWebhook);
/**
 * @openapi
 ...
 */
router.get("/order/:orderId", auth_1.auth, (0, requireRole_1.requireRole)(["buyer", "seller", "admin"]), (0, validate_1.validate)(paymentSchemas_1.getPaymentByOrderSchema), paymentController_1.getPaymentByOrder);
/**
 * @openapi
 * /payments/{id}:
 *   get:
 ...
 *         description: Payment not found
 */
router.get("/:id", auth_1.auth, (0, requireRole_1.requireRole)(["buyer", "seller", "admin"]), (0, validate_1.validate)(paymentSchemas_1.getPaymentByIdSchema), paymentController_1.getPaymentById);
